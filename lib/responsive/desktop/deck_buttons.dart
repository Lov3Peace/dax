...
class SocialsButton extends StatelessWidget {
  ...
  get socialsHeroTag => GlobalProvider().socialsHeroTag;

  @override
  Widget build(BuildContext context) {
    return Consumer<GlobalProvider>(
      builder: (context, value, child) => Animate(
        child: Hero(
          tag: socialsHeroTag,
          flightShuttleBuilder: flightShuttleBuilder,
          child: TactileButton(
            ...
            onTap: () {
              Future.delayed(const Duration(milliseconds: 100)).then((_) {
                final changeHeroTag = context.read<GlobalProvider>();
                changeHeroTag.heroReset();
                print(socialsHeroTag);
