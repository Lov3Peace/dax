...
//
// this houses all the information for the projects button
//
class ProjectsInformation extends StatefulWidget {
  const ProjectsInformation({super.key});

  @override
  State<ProjectsInformation> createState() => _ProjectsInformationState();
}

class _ProjectsInformationState extends State<ProjectsInformation> {
  @override
  Widget build(BuildContext context) {
