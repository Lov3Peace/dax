...
// The class the holds the information in the billing settings button
// note: There is much editing that needs to happen in these section but ultimately
// Ui must be created and better refined

class BillingSettingsInfo extends StatefulWidget {
  BillingSettingsInfo({super.key});

  @override
  State<BillingSettingsInfo> createState() => BillingSettingsInfoState();
}

class BillingSettingsInfoState extends State<BillingSettingsInfo> {
  @override
