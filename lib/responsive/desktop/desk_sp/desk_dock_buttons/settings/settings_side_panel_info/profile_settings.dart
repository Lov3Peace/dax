...
// The class the holds the information in the Profile settings button
// note: There is much editing that needs to happen in these section but ultimately
// Ui must be created and better refined

class ProfileSettingsInfo extends StatefulWidget {
  ProfileSettingsInfo({super.key});

  @override
  State<ProfileSettingsInfo> createState() => ProfileSettingsInfoState();
}

class ProfileSettingsInfoState extends State<ProfileSettingsInfo> {
  @override
