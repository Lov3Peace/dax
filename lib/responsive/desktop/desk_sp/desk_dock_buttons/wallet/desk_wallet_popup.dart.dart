                        ...
                        Padding(
                          ...
                          child: Wrap(
                            children: [
                              ...
                              // looking for.
                              const ReverseSlideButton(deskButtonId: 'wallet', icon: Icons.arrow_left_rounded),
                              Wrap(
                                spacing: 1.w,
                                children: [
                                  Stack(
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Padding(
                                                padding: EdgeInsets.only(bottom: 1.h, left: 2.5.w, top: 5.h),
                                                child: const Text(
                                                  'Pay to',
                                                  style: TextStyle(
                                                    color: Colors.white,
                                            ...
                                            child: SingleChildScrollView(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  const SizedBox(),
                                                  Padding(
                                                    padding: EdgeInsets.only(bottom: 2.h, left: 2.w, top: 5.h),
                                                    child: Text(
