...
class DeskHeroFinancesPage extends StatefulWidget {
  const DeskHeroFinancesPage({Key? key}) : super(key: key);

  @override
  State<DeskHeroFinancesPage> createState() => _DeskHeroFinancesPageState();
}

class _DeskHeroFinancesPageState extends State<DeskHeroFinancesPage>
    with AnimationMixin {
  //globals
