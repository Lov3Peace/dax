...
// The class the holds the information in the Security settings button
// note: There is much editing that needs to happen in these section but ultimately
// Ui must be created and better refined

class SecuritySettingsInfo extends StatefulWidget {
  SecuritySettingsInfo({super.key});

  @override
  State<SecuritySettingsInfo> createState() => SecuritySettingsInfoState();
}

class SecuritySettingsInfoState extends State<SecuritySettingsInfo> {
  @override
